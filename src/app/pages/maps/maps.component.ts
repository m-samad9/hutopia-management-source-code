...
export class MapsComponent implements OnInit {
  ...
  constructor(private router: Router, private enterprise_data_service: EnterpriseDataService, public shared_logic_service: SharedLogicService/*, private nav_title_service: NavTitleService*/) { }
