...
export class IconsComponent implements OnInit {
  ...
  constructor(private user_data_service: UserDataService/*, private nav_title_service: NavTitleService*/) { }
  ...
  getAllUsers(): void {
    this.user_data_service.getAllUsers().subscribe({
      next: response => { 
        ...
        this.info = "999 active users" // this.info = this.users.length + ' active users';
      },
